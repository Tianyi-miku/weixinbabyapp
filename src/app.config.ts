export default defineAppConfig({
  pages: [
    ...
    "pages/fazhan/children/kouqiang/kouqiang",
    "pages/fazhan/children/paibian/paibian",
    "pages/fazhan/children/shenti/shenti",
    // "pages/fazhan/children/shuimian/shuimian",
    "pages/fazhan/children/tizhong/tizhong",
    "pages/index/index",
    "pages/celue/celue",
    "pages/celue/children/jiankangyinshi/jiankangyinshi",
    "pages/celue/children/jinshizhushou/jinshizhushou",
    "pages/yinshi/yinshi",
    "pages/yinshi/children/caidan/caidan",
    "pages/yinshi/children/shiwuzhishi/shiwuzhishi",
    "pages/shiyu/shiyu",
    "pages/gongyu/gongyu",
  ],
  window: {
